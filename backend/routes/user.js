        ...
        if(!err){
            if(results.length <=0){
                ...
                var mailOptions ={
                    ...
                    to: results[0].email,
                    subject: "password for daily need application",
                    html: '<p><b>login details for daily need application</b><br><b>Email: </br>'+results[0].email+'<br><b>Password: </br>'+results[0].password+'<br><a href="http://localhost:4200">click here to login</p>'
                };
